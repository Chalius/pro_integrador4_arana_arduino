...
void retroceder(int tiempoEntrePasos){
  ...
  // TODO, IMPORTANTE:
  // al retroceder la pata izqAtras tiene problemas, hace que se caiga
  // el robot cuando se levanta.
  // para tratar de arreglar esto estuvimos modificando su posición inicio
